...
import { MOVIES_COLLECTION_ORDER } from '@/lib/netflix/constants';
import {
...
const HERO_SLUG = 'trending-movies' as const;

export default function NetflixMoviesPage() {
  const heroQuery = useNetflixCollection(HERO_SLUG);
  const { rows } = useNetflixCollections(MOVIES_COLLECTION_ORDER);
