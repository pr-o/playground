...
import { SHOWS_COLLECTION_ORDER } from '@/lib/netflix/constants';
import {
...
const HERO_SLUG = 'trending-tv' as const;

export default function NetflixShowsPage() {
  const heroQuery = useNetflixCollection(HERO_SLUG);
  const { rows } = useNetflixCollections(SHOWS_COLLECTION_ORDER);
