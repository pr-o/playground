  ...
  return (
    <section className="flex flex-1 flex-col items-center justify-center gap-4 p-6 text-center">
      <div className="space-y-2">
        <h1 className="text-xl font-semibold text-music-primary">Album unavailable</h1>
        <p className="text-sm text-music-muted">
          We couldn&apos;t load this album. {error.message || 'Please try again.'}
        </p>
      </div>
      <button
        type="button"
