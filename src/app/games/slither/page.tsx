...
export default function SlitherPage() {
  return (
    <main className="flex min-h-[calc(100vh-3.5rem)] flex-1 flex-col items-center bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 py-6 text-slate-100">
      <div className="w-full max-w-6xl px-6">
        <header className="space-y-4 text-center">
          <p className="text-2xl uppercase tracking-[0.3em] text-slate-400">Slither</p>
